...
| `docs/decisiones.md` | Qué se decidió y por qué. Se consulta cuando algo parece arbitrario, y se actualiza cuando una decisión cambia. 226 decisiones cerradas y el rastro de los 31 pendientes que se abrieron y resolvieron (M1–M31). |
